      ...
      <View style={styles.container}>
        <View style={styles.card}>
          <View style={styles.icon}>
            <MaterialCommunityIcons name="plus-circle-outline" size={22} color="#111827" />
          </View>
          <Text style={styles.title}>Start Report</Text>
          <Text style={styles.body}>
            This will be the guided report flow entry point. Next we can connect it to your backend
        ...
        <Pressable
          ...
          <Text style={styles.primaryButtonText}>Sign in / Access Code</Text>
